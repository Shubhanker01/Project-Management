...
export default function Home() {
    return (
        <div className="min-h-screen bg-zinc-950 text-white">
            {/* Navbar */}
            <nav className="border-b border-zinc-800 px-8 py-4 flex justify-between items-center md:flex-row">
                <h1 className="text-2xl font-bold">ProjectFlow</h1>

                <div className="flex md:gap-4 gap-2">
                    <button className="md:px-4 px-2 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700">
                        <Link to="/login">
                            Login
                        </Link>
            ...
            <section className="max-w-6xl mx-auto px-8 py-20">
                ...
                <div className="md:mt-8 mt-4 flex gap-4">
                    <button className="bg-blue-600 hover:bg-blue-500 md:px-6 px-3 py-3 rounded-lg font-medium">
                        Create Project
                    </button>

                    <button className="border border-zinc-700 md:px-6 px-3 py-3 rounded-lg hover:bg-zinc-900">
                        View Projects
                    </button>
                </div>
            </section>
            ...
            {/* Stats */}
            <section className="md:max-w-6xl max-w-4xl mx-auto px-8 grid md:grid-cols-4 gap-6">
...
function StatCard({ title, value }) {
    return (
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            ...
            <h3 className="md:text-3xl text-xl font-bold mt-2">{value}</h3>
        </div>
    );
}
